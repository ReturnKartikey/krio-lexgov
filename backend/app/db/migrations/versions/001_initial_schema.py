...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('source_id', sa.String(36), sa.ForeignKey('sources.id', ondelete='CASCADE'), nullable=False),
        sa.Column('raw_document_id', sa.String(36), sa.ForeignKey('raw_documents.id', ondelete='SET NULL'), nullable=True),
    ...
    op.create_index('ix_records_source_ext_id', 'records', ['source_id', 'external_id'], unique=True)
    ...
    op.create_index('ix_record_entity_unique', 'record_entities', ['record_id', 'entity_id', 'role'], unique=True)
    ...
    op.create_table(
        'crawl_state',
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('source_id', sa.String(36), sa.ForeignKey('sources.id', ondelete='CASCADE'), nullable=False, unique=True),
